...
public class MCTSGamer extends GrimgauntPredatorGamer {
	...
	public class TreeNode {
	    ...
	    public double simulate() throws TransitionDefinitionException, MoveDefinitionException, GoalDefinitionException { //, MoveSelectionException {
	    	...
	    	double goal = 0;
	    	//try {
	    		goal = sm.getGoal(finalState, getRole());
	    	//}
