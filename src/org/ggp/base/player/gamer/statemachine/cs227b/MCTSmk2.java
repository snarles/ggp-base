...
public class MCTSmk2 extends GrimgauntPredatorGamer {
	...
	public class MaxNode {
		...
		public MaxNode select() {
			...
			for (MinNode child : this.children) {
				double childScore = child.score+Math.sqrt(2*Math.log(this.visits)/child.visits);
		...
		public int simulate() throws GoalDefinitionException, TransitionDefinitionException, MoveDefinitionException {
		...
		public void propagate(double value) {
			if (value > this.score) this.score = value;
			this.visits++;
